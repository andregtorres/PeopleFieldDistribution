...
if (verbose > 0) : print "Nx,Ny= ",l0.Nx," , ",l0.Ny
if (verbose > 0) : print "time resolution= ",l0.dt, "s"
if (verbose > 0) : print "time steps", nSteps
                ...
                if y>0:
                    try:
                        if (not l0.locked[x][y]) :
                            ...
                            if d > 0 and d<=ran:
                                wallField[x][y]+=a*l0.gridResol*l0.gridResol/((ran*l0.gridResol)**2-1.)*(ran**2/d**2-1.)
    ...
    for x, l in enumerate(l0.doorField):
        for y, c in enumerate(l):
            if not l0.locked[x][y]:
                ...
                l0.doorField[x][y]=(value2_ + dDoor*l0.gridResol)
...
out.plotGraphs(31,0, True)
#out.plotGraphs(21,0, True)
